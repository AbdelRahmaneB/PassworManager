...
public abstract class DataEncryption {
     ...
     * @throws Exception
     */
    public static String encryptData(String key, String valueToEncrypt) throws Exception {
     ...
     * @throws Exception
     */
    public static String decryptData(String key, String encryptedValue) throws Exception {
        byte[] cryptKey = getEncryptKey(key.getBytes());
     ...
     */
    private static byte[] mStringToByte(String hexValue) {
     ...
     */
    private static String mByteToHexadecimal(byte[] value) {
        if (value == null)
            return "";
     ...
     */
    private static void appendHex(StringBuffer value, byte mByte) {
